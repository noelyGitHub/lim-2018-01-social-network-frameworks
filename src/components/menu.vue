    ...
    <div class="nav-wrapper">
      <div class="container">
        ...
        <ul class="right hide-on-med-and-down">
          <li v-on:click="postPublic(false)" >HOME</li>
          <li v-on:click="postPrivacy(true)" class='content-photo-view-profile' ><img :src='photoUser' alt='photo-profile' id="btnLogOut"></li>
          <li class='name-view-data'><p>{{userLogin}}</p></li>
          <li class='name-view-data'><p v-on:click= "logout">Logout</p></li>
        </ul>
...
export default {
  ...
  methods: {
    ...
    postPrivacy(value) {
      alert('pry')
      this.$emit('privacy-status', value)
    },
    postPublic(value){
      alert('public')
      this.$emit('privacy-status', value)
